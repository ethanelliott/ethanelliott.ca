 ...
 *
 * The service worker only caches the app shell — the dashboard streams live
 * video and events and is useless offline — so this exists purely to keep
 * installed clients up to date.
 */
