 ...
 *
 * The service worker only caches the app shell — Split intentionally has no
 * offline data caching and always talks to the network for API calls — so this
 * exists purely to keep installed clients up to date.
 */
