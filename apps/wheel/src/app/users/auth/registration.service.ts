...
export class RegistrationService {
  ...
  async startRegistration(
    ...
    return {
      ...
      message:
        '🔑 Account created! Complete passkey setup to secure your wheels.',
    };
  }
  ...
  async completeRegistration(
    ...
    const accessToken = fastify.signToken({ id: userId });
    ...
    return {
      ...
      message: '🎉 Welcome! Your wheels are now secured with a passkey.',
    };
  }
}
