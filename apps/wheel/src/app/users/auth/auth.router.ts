...
export async function AuthRouter(fastify: FastifyInstance) {
  ...
  /**
   * 📝 REGISTER USER (anonymous account + passkey)
   */
  typedFastify.post(
    '/register',
    {
      schema: {
        tags: ['Authentication'],
        description:
          'Create a fresh anonymous account — a passkey is bound to a random id.',
  ...
  /**
   * 🔑 START LOGIN (usernameless / discoverable passkey)
   */
  typedFastify.post(
    '/login',
    {
